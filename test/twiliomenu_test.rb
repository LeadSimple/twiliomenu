...
describe Call do
  ...
  describe "Class Modifications" do
    ...
    describe "Added Instance Methods" do
      ...
      describe "#process_twilio_response" do
        it "only processes the relevant menu once" do
          call = Call.new
          call.current_menu.must_equal :opening_menu
          call.process_twilio_response({ Digits: "1" })
          call.current_menu.must_equal :second_menu
          call.process_twilio_response({ Digits: "2" })
          call.current_menu.must_equal :third_menu
        end
      end
    end
  end
